...
def test_download_uprair(tmp_path: Path) -> None:
    """Test that get_data.py successfully downloads uprair data to a temporary location."""
    ...
    assert downloaded_file.name.endswith(".uprair.tm00.bufr_d")
